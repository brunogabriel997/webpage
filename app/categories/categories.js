...
function getLine(category)
{
    ...
    //botao para editar o conteudo
        cat+="<button class='btn btn-primary m-r-10px update-category-button' data-id='"+category["id"]+"'>";
        cat+="<span class='glyphicon glyphicon-edit'></span> Editar";
        cat+="</button>";
    //botao para remover o conteudo
       cat+="<button class='btn btn-primary m-r-10px delete-category-button' data-id='"+category["id"]+"'>";
...
{
    var cat="";
    cat+="<a href='http://localhost:8080/apirest/categorias/exportar_CSV.php' class='btn btn-primary pull-right'>";
