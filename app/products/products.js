...
function criar_bt_p()
{
    ...
    txt+="<a href='http://localhost:8080/apirest/produtos/export_csv.php' class='btn btn-info pull-right margin-right-1em' title='Descarregar ficheiro'><span class='glyphicon glyphion-download-alt'></span> Exportar CSV</a>";
    return txt;
}
